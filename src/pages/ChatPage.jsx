...
const ChatPage = ({ user, onLogout }) => {
  ...
  const [selectedRoom, setSelectedRoom] = useState(8);

  // 메시지 조회 함수
  const fetchMessages = async () => {
    try {
      const response = await fetch(`${BASE_URL}/chatmsg/${selectedRoom}`, {
        method: "GET",
        headers: {
        ...
        <div className="max-w-2xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="text-xs text-gray-400">방 {selectedRoom}</div>
              <button
